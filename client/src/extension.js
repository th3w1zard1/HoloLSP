...
function activate(context) {
    ...
    const clientOptions = {
        ...
        synchronize: {
            ...
            fileEvents: vscode_1.workspace.createFileSystemWatcher("**/*.{nss,ncs}"),
        },
    };
    // Create the language client and start the client.
    client = new node_1.LanguageClient("holo-lsp", "HoloLSP - KOTOR NWScript Language Server", serverOptions, clientOptions);
